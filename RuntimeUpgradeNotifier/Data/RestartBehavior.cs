...
public enum RestartBehavior {
    ...
    /// <para>This uses <see cref="Environment.Exit"/>, but you may instead switch to <see cref="Data.RestartBehavior.AutoStartNewProcess"/> if you want to use a more specialized exit technique like Forms' <c>Application.Exit()</c>, WPF's <c>Application.Current.Shutdown()</c>, or the .NET Host's <c>IHostApplicationLifetime.StopApplication()</c>.</para>
    /// </summary>
    AutoRestartProcess
